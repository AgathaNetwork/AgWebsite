var playerData,playerPrefixes,playerOnline;
	function GetPlayerData(){
		...
		xmlhttp.open("GET", "https://api-openid.agatha.org.cn/info/incrementalLevel", false);
		xmlhttp.send();		
	}
	function GetPlayerPrefixes(){
		var xmlhttp = new XMLHttpRequest();
		xmlhttp.onreadystatechange = function(){
			if (this.readyState == 4 && this.status == 200){
		...
		xmlhttp.open("GET", "https://api-openid.agatha.org.cn/info/getPlayerPrefix", false);
		xmlhttp.send();
	}
